...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.imgSampleOne -> {
                setViewAndDetect(getSampleImage(R.drawable.cantaloupe))
            }
            R.id.imgSampleTwo -> {
                setViewAndDetect(getSampleImage(R.drawable.maprang))
            }
            R.id.imgSampleThree -> {
                setViewAndDetect(getSampleImage(R.drawable.wollongong))
            }
            R.id.imgSampleFour -> {
                setViewAndDetect(getSampleImage(R.drawable.champedak))
            }
            R.id.imgSampleFive -> {
                setViewAndDetect(getSampleImage(R.drawable.apple))
            }
            R.id.imgSampleSix -> {
                setViewAndDetect(getSampleImage(R.drawable.salak))
            }
        }
    }
